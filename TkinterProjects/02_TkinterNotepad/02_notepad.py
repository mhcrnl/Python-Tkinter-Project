...
class Notepad(tk.Frame):
    def __init__(self, parent, *args, **kwargs):
        ...
        self.pyth.add_command(label="Create dir", command=self.createdir)
        ...
        self.pyth.add_command(label="ttk.Entry", command=self.ttkEntry)
    ...
    def ttkEntry(self):
        ...
        line2 = "Accept single line text string\n"
        line3 = "text_ent = ttk.Entry(master, options, ...)\n"
        line4 = "\"\"\"\n"
        line7 = "text = tk.StringVar()\n"
        line5 = "self.text_ent = ttk.Entry(self, textvariable=text)\n"
        line6 = "self.text_ent.pack(side= tk.RIGHT)"
        self.text_area.insert(tk.INSERT, line1)
        self.text_area.insert(tk.INSERT, line2)
        self.text_area.insert(tk.INSERT, line3)
        self.text_area.insert(tk.INSERT, line4)
        self.text_area.insert(tk.INSERT, line7)
        self.text_area.insert(tk.INSERT, line5)
        self.text_area.insert(tk.INSERT, line6)
    ...
    #### =================================================
    def templates(self):
        shutil.copy("./Templates/__main__.py", "./MyNewApp/__main__.py")
